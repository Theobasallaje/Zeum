...
export const EightArtifactRoom = () => {
    ...
    return (
        <>
            ...
            {/* Inner Right Wall */}
            <Wall position={[-75, 2.5, -4.625]} width={2} height={5} depth={39.25} />

            {/* Right Wall */}
            <Wall position={[-124, 2.5, 7]} width={2} height={5} depth={roomDepth / 1.25} />
            ...
            {/* 2nd Room Floor */}
            <Floor position={[-100, 0, 7]} width={roomWidth} depth={roomDepth / 1.25} />

            {/* 2nd Room Front Wall */}
            <Wall position={[-100, 2.5, -24]} horizontal width={2} height={5} depth={50} visible={false} />
