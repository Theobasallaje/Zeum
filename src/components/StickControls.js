...
export const StickControls = ({ enableJoystick, enableKeyboard, orbitProps = {}, camProps = {} }) => {
    ...
    return (
        <>
            ...
            <RigidBody ref={characterRef} scale={[0.5, 0.5, 0.5]} enabledRotations={[false, false, false]}>
                <CuboidCollider args={[0.5, 0.5, 0.5, 0.5]} />

                <Box scale={[2, 2, 2]} receiveShadow castShadow></Box>
            </RigidBody>
        </>
    );
};
