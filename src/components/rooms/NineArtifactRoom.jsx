...
export const NineArtifactRoom = () => {
    ...
    return (
        <>
            ...
            {/* Inner Right Wall */}
            <Wall position={[-75, 2.5, -12]} width={2} height={5} depth={INNER_WALL_MAX_DEPTH} />
            ...
            {/* 2nd Room Front Wall */}
            <Wall position={[-100, 2.5, -38]} horizontal width={2} height={5} depth={50} visible={false} />
